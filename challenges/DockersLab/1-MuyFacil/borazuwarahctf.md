...
Obtener acceso al sistema mediante reconocimiento, enumeración y explotación, y escalar privilegios a **root**.

> Metodología: Reconocimiento → Enumeración → Identificación de ataque → Explotación → Escalada.
...
Usamos **Gobuster** para buscar directorios y archivos.
...
No hay rutas explotables. Enfocamos la atención en la imagen de `index.html`.
...
Usamos **Hydra** con la lista `claves.txt`:
